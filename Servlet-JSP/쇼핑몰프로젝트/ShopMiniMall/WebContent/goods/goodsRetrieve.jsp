...
<%
	...
	System.out.println("제품 상세: " + dto.toString());
%>
<form name="goodRetrieveForm" method="GET" action="#">
	<input type="hidden" name="gImage" value="<%= gImage %>"> <input
		type="hidden" name="gCode" value="<%=gCode %>"> <input type="hidden"
		name="gName" value="<%=gName %>>"> <input type="hidden"
		name="gPrice" value="<%=gPrice %>">
		...
		<tr>
			<td>
				<table align="center" width="710" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td rowspan="7"><img src="images/items/<%= gImage %>.gif" border="0"
