...
<form action="MemberUpdateServlet" method="post">
	...
	*아이디: <%= userid %>
	...
	<input type="text" value="<%= addr1 %>" name="addr1" id="sample4_roadAddress"
		...
		type="text" value="<%= email1 %>" name="email1" id="email1">@ <input
		type="text" value="<%= email2 %>" name="email2" id="email2" placeholder="직접입력">
